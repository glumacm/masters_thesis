...
import { ResponseMessage, SyncEntityWithCommandsWorkerResponse, SynchronizationPostData, SynchronizationSyncedObject, SynchronizationSyncEntityRecord, SynchronizationSyncResponse } from "../interfaces/sync-process.interfaces";
...
import { RetryManagementWorkerData, RetryManagerWorkerMessageDataI } from "../interfaces/retry-sync.interfaces";
import { RetryManagerMessageCommandEnum } from "../enums/retry.enum";
    ...
    await sync_entity_records_batch(getObjectNameToPathMapper('')[objectName], entityRecords, requestUuid).then(
        ...
        async (error) => {
            ...
            if (error.code === SynchronizationSyncStatus.ECONNABORTED || error.code === SynchronizationSyncStatus.ERR_NETWORK) {
                ...
                const responseToParentWorker = {} as SyncEntityWithCommandsWorkerResponse;
                responseToParentWorker.command = SyncEntityWithCommandsWorkerCommandEnum.SYNC_ENTITY_TIMEOUT;
                ...
                responseToParentWorker.data = dataForRetryManagement;
                postMessage(
                    responseToParentWorker
                );
