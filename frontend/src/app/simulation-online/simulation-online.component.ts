...
@Component({
  selector: 'app-simulation-online',
  templateUrl: './simulation-online.component.html',
  styleUrls: ['./simulation-online.component.scss']
})
export class SimulationOnlineComponent {
  ...
  constructor(
    ...
    this.syncLib = new SynchronizationLibrary(false, false, DEFAULT_MERCURE_SYNC_POLICY, undefined, false);
